                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="p-4 my-auto">
                                    <div class="text-center">
                                        <h4 class="fs-20">Seller Sign Up</h4>
                                    ...
                                    <form method="POST" action="{{ route('seller.register') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="fullname" name="company"
                                                placeholder="Compnay name" required="">
                                        </div>
                                        <div class="mb-3">
                                            <label for="fullname" class="form-label">Company Address</label>
                                            <input class="form-control" type="text" id="fullname" name="address"
                                                placeholder="Compnay Address" required="">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="fullname" class="form-label">Trade License Number</label>
                                            <input type="text" name="t_license" class="form-control" placeholder="Trade License">
                                        ...
                                        <div class="col-12 text-center">
                                            <p class="text-dark-emphasis">Already have account? <a href="{{ route('seller.login') }}"

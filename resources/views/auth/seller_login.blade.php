        ...
        <div class="container">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="p-4 my-auto">
                                        <div class="text-center">
                                            <h4 class="fs-20">Sign In as Seller</h4>
                                        ...
                                        <form method="POST" action="{{ route('seller.login') }}">
                                            ...
                                            <div class="alert alert-warning alert-dismissible fade show">
                                                Your account is currently inactive. Please wait for varification.
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p class="text-dark-emphasis">Don't have an account? <a href="{{ route('seller.register') }}"

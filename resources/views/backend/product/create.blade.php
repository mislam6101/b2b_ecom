                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="simpleinput" class="form-label">Minimum Order Quantity <span style="color: red;">*</span></label>
                                        <input type="text" id="simpleinput" class="form-control" name="prod_moq">
                                    </div>
                                </div>
                                <div class="mb-3">

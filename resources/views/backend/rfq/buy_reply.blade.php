                                ...
                                <table id="selection-datatable"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $rfq->buyer->company }}</td>
                                            <td>{{ $rfq->buyer->email }}</td>
                                            <td>{{ $rfq->quantity }}</td>
                                            <td>{{ $reply->message }}</td>
                                            <td>${{ $reply->quoted_price ?? '-' }}</td>
                                            <td>{{ $reply->delivery_date ?? '-' }}</td>
                                            <td>{{ ucfirst($reply->status) ?? 'Pending' }}</td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            ...
                                            <td colspan="4" class="text-center">No replies yet</td>
                                        </tr>
                                        @endforelse
                                        @endforeach
                                    </tbody>

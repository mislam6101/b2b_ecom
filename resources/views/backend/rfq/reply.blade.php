                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title">Reply for Qutation</h4>

                        </div>
                        <div class="card-body">
                            <div class="row">
                                <p><strong>Buyer:</strong> {{ $rfq->buyer->company }}</p>
                                <p><strong>Product:</strong> {{ $rfq->product_name }}</p>

                                <div class="col-lg-6">
                                    <form method="POST" action="{{ route('seller.rfq.reply.submit', $rfq->id) }}">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Message <span style="color: red;">*</span></label>
                                            <input type="text" id="simpleinput" class="form-control" name="message">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Quoted Price</label>
                                            <input type="number" step="0.01" name="quoted_price" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Delivery Date <span style="color: red;">*</span></label>
                                            <input type="date" name="delivery_date" id="simpleinput" class="form-control">
                                        </div>
